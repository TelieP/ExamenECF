        ...
        <div class="row">
            <article class="col-md-4 col-lg-4 col-xs-12 col-sm-12">
                ...
                <p>
                    ...
                    aux forêts tropicales humides abritant nos tigres, chaque espace est une invitation à un voyage à travers les continents. 
                    Les éléments naturels tels que la végétation,l'eau et les structures rocheuses sont intégrés pour favoriser le bien-être 
                    animal et encourager les comportements naturels.
            ...
            <article class="col-md-4 col-lg-4 col-xs-12 col-sm-12">
                ...
                <p>
                Nous croyons fermement que la découverte de la faune doit être accessible à tous. C'est pourquoi Arcadia 
                Zoo s'engage à offrir une expérience inclusive, avec des habitats adaptés aux personnes à mobilité réduite. 
